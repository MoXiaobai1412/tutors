// pages/detailPage/studentPage/studentPage.js
Page({
  data: {
    _id:null,
    db:null,
  ...
  checkFavor(e){
    const favor = wx.getStorageSync('favorList').student
    if(favor.includes(e)){
      this.setData({
        isFavor:true
      })
  ...
  creatChat(){
    let information = {
      ...
      docid:this.data.information._id
    }
        ...
        if(err===0){
          ...
          wx.showModal({
            ...
            complete: (res) => {
              ...
              if (res.confirm) {
                wx.navigateTo({
                  url: `/pages/message/chat/chat?id=${errMessage}`,
                })
              }
            }
          })
